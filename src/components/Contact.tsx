    ...
    <section id="contact" className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {contactInfo.map((info, index) => (
                <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 bg-white/80 backdrop-blur-sm animate-fade-in" style={{animationDelay: `${index * 150}ms`}}>
            ...
            {/* Quick Contact Form */}
            <Card className="border-0 shadow-xl bg-gradient-to-br from-gray-50 to-white animate-fade-in" style={{animationDelay: '600ms'}}>
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-12 bg-green-600 hover:bg-green-700 text-white font-medium text-lg transition-all duration-300 hover:scale-105 shadow-lg"
                  >
                    Send message
                  </Button>
                </form>
          ...
          <div className="space-y-8">
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-green-50 via-white to-gray-50 animate-fade-in" style={{animationDelay: '800ms'}}>
            ...
            <Card className="border-0 shadow-lg bg-gray-900 text-white animate-fade-in" style={{animationDelay: '1000ms'}}>
              <CardContent className="p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button variant="outline" className="flex-1 border-white text-white hover:bg-white hover:text-gray-900">
