...
const HeroSlider = () => {
  ...
  return (
    <>
      <section className="min-h-[70vh] lg:min-h-[65vh] bg-white flex items-center relative overflow-hidden hero-mobile-padding pt-24 sm:pt-28 lg:pt-32 -mb-24 sm:-mb-28 lg:-mb-32">
