                  ...
                  <CardContent className="p-6 sm:p-8 flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <div className="relative">
                        {/* Premium glow effect */}
                        <div className="absolute -inset-2 bg-gradient-to-r from-green-400/20 to-emerald-500/20 rounded-lg blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        
                        {/* Pricing container */}
                        <div className="relative bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200/50 rounded-xl px-3 py-2 sm:px-4 sm:py-3 group-hover:border-green-300/70 transition-all duration-300">
                          <div className="text-xs text-green-700/80 uppercase tracking-wider font-semibold mb-1">Starting at</div>
                          ...
                          {/* Subtle accent line */}
                          <div className="absolute bottom-0 left-3 right-3 h-0.5 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full opacity-60"></div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
