...
import TrustFactors from "./about/TrustFactors";
import ProcessWorkflow from "./about/ProcessWorkflow";
      ...
      <section id="about" className="py-32 bg-gradient-to-br from-slate-900 via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mb-24">
            ...
            <h1 className="text-6xl lg:text-8xl font-extralight text-white mb-8 leading-tight animate-fade-in tracking-tight" style={{animationDelay: '200ms'}}>
              Defining the
            ...
            <div className="space-y-6 animate-fade-in" style={{animationDelay: '400ms'}}>
              <p className="text-2xl text-gray-300 leading-relaxed font-light">
                Cardinal Consulting is a <span className="text-green-400 font-medium">premier digital transformation consultancy</span> that partners with Fortune 500 companies and emerging market leaders to create exceptional digital experiences.
              </p>
              <p className="text-xl text-gray-400 leading-relaxed">
                We don't just build software—we craft digital solutions that drive real business growth, enhance user experiences, and position our clients for long-term success in an increasingly digital world.
              </p>
            </div>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="space-y-6 text-gray-300 leading-relaxed">
                  <p className="relative pl-6 border-l-2 border-green-400/30">
                    ...
                    across multiple industries and geographies, with a proven track record of success spanning over 15 years.
                  </p>
                  ...
                  <p className="relative pl-6 border-l-2 border-blue-400/30">
                    ...
                    interaction by optimizing content and experiences for next-generation AI systems and intelligent search.
                  </p>
                  ...
                  <p className="relative pl-6 border-l-2 border-emerald-400/30">
                    ...
                    and deep industry expertise to deliver <span className="text-emerald-400 font-medium">transformational outcomes</span> that exceed expectations.
                  </p>
                </div>
              </div>
