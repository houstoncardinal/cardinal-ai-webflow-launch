    ...
    <section id="portfolio" className="py-32 bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-bl from-purple-500/10 via-transparent to-pink-500/10 animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent animate-pulse top-2/3" style={{animationDelay: '1.5s'}}></div>
        </div>
            ...
            <defs>
              <pattern id="hexPattern" width="10" height="8.66" patternUnits="userSpaceOnUse">
                <polygon points="5,0 9.33,2.5 9.33,7.5 5,10 0.67,7.5 0.67,2.5" 
                         fill="none" stroke="#10b981" strokeWidth="0.2" opacity="0.6"/>
              </pattern>
            </defs>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mb-24 text-center mx-auto">
          ...
          <h2 className="text-5xl lg:text-7xl font-extralight text-white mb-8 leading-[1.1] tracking-tight animate-fade-in" style={{animationDelay: '300ms'}}>
            Featured
          ...
          <p className="text-xl text-gray-300 leading-relaxed font-light max-w-3xl mx-auto animate-fade-in" style={{animationDelay: '500ms'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
          {projects.map((project, index) => (
            <Card 
              key={index} 
              className="group relative overflow-hidden border-0 bg-gradient-to-br from-gray-900/80 via-slate-900/90 to-gray-900/80 backdrop-blur-xl shadow-2xl hover:shadow-emerald-500/20 transition-all duration-700 cursor-pointer animate-fade-in"
              style={{
                ...
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {project.tags.map((tag, tagIndex) => (
                      <span 
                        key={tagIndex} 
                        className="text-xs text-gray-300 bg-gray-800/60 border border-gray-600/50 px-3 py-2 rounded-full group-hover:bg-emerald-900/30 group-hover:border-emerald-500/50 group-hover:text-emerald-300 transition-all duration-500 backdrop-blur-sm"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full bg-gradient-to-r from-emerald-600/20 to-cyan-600/20 border-emerald-500/50 text-emerald-300 hover:from-emerald-600/40 hover:to-cyan-600/40 hover:border-emerald-400 hover:text-white transition-all duration-500 backdrop-blur-sm shadow-lg hover:shadow-emerald-500/25 group/btn"
                  >
