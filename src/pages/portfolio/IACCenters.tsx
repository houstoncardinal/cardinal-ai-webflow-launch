...
const IACCenters = () => {
  const project = {
    ...
    category: "Healthcare",
    description: "Top-quality chiropractic care and holistic health services for the Dallas-Fort Worth Metroplex community",
    image: "/iac.png",
    tags: ["Chiropractic Care", "Holistic Health", "Injury Recovery", "Pain Management"],
    metrics: {
      timeline: "4 weeks",
      team: "3 developers",
      impact: "60% increase in patient inquiries"
    },
    industry: "Healthcare",
    services: ["Website Design", "Patient Portal", "Appointment Booking", "SEO Optimization"],
    longDescription: "At Injury Assistance Centers, we are dedicated to providing top-quality chiropractic care and holistic health services to the Dallas-Fort Worth Metroplex community. Our mission is to help individuals recover from injuries, manage pain, and achieve optimal health and wellness through comprehensive and personalized treatment plans.",
    technologies: ["React", "Node.js", "PostgreSQL", "Stripe", "Calendar API", "Responsive Design"],
    results: [
      "60% increase in patient inquiries",
      "Streamlined appointment booking system",
      "Enhanced patient education resources",
      "Improved online patient engagement"
    ],
    challenge: "IAC needed a professional healthcare website that could showcase their chiropractic services, handle online appointment bookings, and provide patients with educational resources about injury recovery and pain management. The site needed to build trust and credibility in the healthcare industry.",
  ...
  return (
    <>
      <SEO 
        ...
        keywords={`${project.title}, chiropractic care, healthcare, website design, Dallas-Fort Worth, portfolio, Cardinal Consulting`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center text-sm font-medium text-red-600 uppercase tracking-wide mb-6">
                <div className="w-12 h-px bg-gradient-to-r from-red-400 to-red-600 mr-6"></div>
                Portfolio Project
              </div>
              
              <h1 className="text-5xl lg:text-6xl font-light text-gray-900 leading-tight">
                {project.title}
                <span className="block text-red-600 font-normal mt-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                ...
                <Button 
                  ...
                  className="border-red-300 text-red-700 hover:bg-red-50 px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105"
                >
                  Start Your Project
                </Button>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
                <div className="text-center">
                  <div className="text-2xl font-bold text-red-600">{project.metrics.timeline}</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A comprehensive digital transformation for Dallas-Fort Worth's trusted chiropractic care provider
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Measurable improvements that transformed IAC's digital presence
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-red-600 to-red-700 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              asChild
              className="bg-white text-red-600 hover:bg-gray-100 px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
            >
              <Link to="/contact">
                Start Your Project
            ...
            <Button 
              variant="outline" 
              asChild
              className="border-white text-red-600 hover:bg-white hover:text-red-600 px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 group"
            >
              <Link to="/portfolio">
                View All Projects
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
