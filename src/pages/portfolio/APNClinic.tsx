...
const APNClinic = () => {
  const project = {
    ...
    category: "Healthcare",
    description: "Advanced pain management solutions for traumatic brain injury and PTSD, specializing in neck, back, arm, shoulder, knee, foot, ankle, and hip treatments",
    image: "/apn.png",
    tags: ["Pain Management", "Neurology", "TBI Treatment", "PTSD Care"],
    metrics: {
      timeline: "5 weeks",
      team: "5 developers",
      impact: "55% increase in patient inquiries"
    },
    industry: "Healthcare",
    services: ["Website Design", "Patient Portal", "Service Showcase", "SEO Optimization"],
    longDescription: "Advanced Pain and Neurology provides comprehensive pain management solutions for traumatic brain injury and PTSD. We specialize in treating neck, back, arm, shoulder, knee, foot, ankle, and hip conditions using advanced minimally invasive techniques.",
    technologies: ["React", "Node.js", "PostgreSQL", "Stripe", "Medical API", "Responsive Design"],
    results: [
      "55% increase in patient inquiries",
      "Streamlined appointment booking system",
      "Enhanced patient education resources",
      "Improved online patient engagement"
    ],
    challenge: "APN Clinic needed a professional healthcare website that could showcase their comprehensive pain management services, handle online appointment bookings, and provide patients with educational resources about their treatment options. The site needed to build trust and credibility in the healthcare industry while explaining complex medical procedures in an accessible way.",
  ...
  return (
    <>
      <SEO 
        ...
        keywords={`${project.title}, pain management, neurology, healthcare, website design, portfolio, Cardinal Consulting`}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A comprehensive digital transformation for Texas's trusted pain management and neurology clinic
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="inline-flex items-center text-sm font-medium text-purple-600 uppercase tracking-wide mb-6">
                <div className="w-8 h-px bg-purple-400 mr-4"></div>
                The Challenge
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Measurable improvements that transformed APN Clinic's digital presence
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={() => window.location.href = '/contact'} 
              className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              Start Your Project
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            ...
            <Button 
              ...
              className="border-white text-white hover:bg-white hover:text-purple-600 px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105"
            >
              View All Projects
            </Button>
          </div>
