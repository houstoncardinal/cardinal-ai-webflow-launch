-- Remove ALL blog posts except the 3 manually uploaded ones
-- This script will clean up your database completely

-- First, let's see what we have
SELECT 'Current blog posts:' as info;
SELECT slug, title, status FROM blog_posts ORDER BY published_at DESC;

-- Remove ALL blog posts first
DELETE FROM blog_posts;

-- Now insert only the 3 blog posts you want to keep
...
-- Verify the result
SELECT 'Final blog posts:' as info;
SELECT slug, title, status FROM blog_posts ORDER BY published_at DESC; 